package convert // import "go.khulnasoft.com/daemon/cluster/convert"

import (
	"fmt"
	"strings"

	types "go.khulnasoft.com/api/types/swarm"
	"go.khulnasoft.com/api/types/swarm/runtime"
	"go.khulnasoft.com/pkg/namesgenerator"
