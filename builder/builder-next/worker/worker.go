...
import (
	...
	imageadapter "go.khulnasoft.com/builder/builder-next/adapters/containerimage"
	mobyexporter "go.khulnasoft.com/builder/builder-next/exporter"
	distmetadata "go.khulnasoft.com/distribution/metadata"
	"go.khulnasoft.com/distribution/xfer"
	"go.khulnasoft.com/image"
	"go.khulnasoft.com/internal/mod"
	"go.khulnasoft.com/layer"
	pkgprogress "go.khulnasoft.com/pkg/progress"
