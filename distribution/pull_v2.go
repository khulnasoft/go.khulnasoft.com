package distribution // import "go.khulnasoft.com/distribution"
...
import (
	...
	"github.com/khulnasoft/distribution/manifest/manifestlist"
	"github.com/khulnasoft/distribution/manifest/ocischema"
	"github.com/khulnasoft/distribution/manifest/schema1"
	"github.com/khulnasoft/distribution/manifest/schema2"
	"github.com/khulnasoft/distribution/registry/client/transport"
	"go.khulnasoft.com/distribution/metadata"
	"go.khulnasoft.com/distribution/xfer"
	"go.khulnasoft.com/image"
	v1 "go.khulnasoft.com/image/v1"
...
func (p *puller) pullSchema2Layers(ctx context.Context, target distribution.Descriptor, layers []distribution.Descriptor, platform *ocispec.Platform) (id digest.Digest, err error) {
	...
	// https://go.khulnasoft.com/issues/24766 - Err on the side of caution,
