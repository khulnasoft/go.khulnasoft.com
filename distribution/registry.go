...
import (
	...
	"github.com/khulnasoft/distribution/registry/client"
	"github.com/khulnasoft/distribution/registry/client/auth"
...
var (
	...
	defaultImageTypes = []string{
		...
		// Handle unexpected values from https://github.com/khulnasoft/distribution/issues/1621
		// (see also https://go.khulnasoft.com/issues/22378,
		// https://go.khulnasoft.com/issues/30083)
		"application/octet-stream",
		"application/json",
		"text/html",
