...
// fs_unix_test.go.
//
// [LICENSE.APACHE]: https://go.khulnasoft.com/sys/blob/symlink/v0.2.0/symlink/LICENSE.APACHE
// [LICENSE.BSD]: https://go.khulnasoft.com/sys/blob/symlink/v0.2.0/symlink/LICENSE.APACHE
package symlink
